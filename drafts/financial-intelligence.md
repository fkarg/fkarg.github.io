...
<!-- not happy with that, but it'll have to suffice for now -->
...
potential roadblocks (and why they are not actually roadblocks).
...
## Part Two: The (Many) Pecularities of the Income Statement
...
even if they might have happened previously. Not all expenses are immediately
visible.

Cash-based accounting has incredible volatility, accrual accounting creates a
much more accurate picture of reality. Over time, profit will be turned into
cash - but usually later than when it is being recognized.
