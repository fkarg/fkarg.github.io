...
substance. Hype doesn't come from nothing usually, so I decided to take a
closer look. When encountering in a bookstore early March, I just bought it.
Even if it wasn't true, I wanted to find a few additional ways to be more
...
reason, and abusing those that are perceived differently.
...
considerably. This will improve your focus, your energy, and your available
time.

He introduces Virtual Personal Assistents, and explains a lot about them. This
includes a variety of options, criteria for selection, which capabilities are
available where, and how much it tends to cost.

A muse is his description of a personal business with minimal effort each week
(less than four hours each week), but still provides enough money to live from
comfortably. For this, a roadmap is laid out, with criteria, initial
investments and a lot of tips on how to proceed and what to watch out for.

Afterwards, it is possible to easily start working from home, or, more
specifically, wherever. This will allow for mini-retirements, which is
...
- Automate, but also optimize. Always eliminate before automation, or you magnify inefficiencies
- Muse
    - criteria, initial investments, tips, rough framework
    - what to look out for, individual steps, looking professional
- Liberation:
    - Convince your boss to let you work from home
- Mini-retirements, two goals:
    - Learn the language
    - Learn a new skill

- most of the benefits can be taken simply by working remote and travelling
  (without reducing workload)

- Filling the void: do something useful / service for community


## Criticism
- 'Cold', amoral demeanour
...
^ I really like this quote, it says a lot about our current reality.
