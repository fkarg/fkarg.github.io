...
# Goal Setting
- Imagine not doing anything vs. being really productive. Reality is probably somewhere inbetween
- Goal Elicitation - write down long list of things that excite you, or would make you feel fulfilled, or just things you strive for or would like to have
- Goal Selection - Select a small set of goals to work on; go for depth not breadth
    - Ask "why" you want it multiple times. (3-5x)
        - If you would have all the reasons you listed fulfilled, would there still be a reason to aim for it?
    - Prioritization: Is it really essential? What is its priority?
        - "If I achieved all my goals _except_ this one, would I be satisfied?"

# Planning
- Goal Definition: Make clear when/if the goal is achieved, split in subgoals if it makes it easier to measure
    - Set a challenging but achievable Deadline
    - Is the Goal Challenging, Specific, Immediate and Approach-oriented (framed in positive language)?
    - Beware of Shoals: Things that seem like the goal, but are not; make a list of failures by succeeding (death by winning)
        - Find Ways to prevent that from happening
- Identify Major intermediate Milestones on the path of getting there
- Define Concrete next action steps you can do **now**, tomorrow and the day after tomorrow - Do the now **now** and the others before 11am (or no later than 4h after waking up) each day.

# Execution
- Always have at least one next action to work on for each Goal
- Have a Dashboard of current progress
- Review Progress regularly, such as weekly or monthly
- adapt plans as necessary (and it will be, the very idea of your goals is to change yourself), quote:
