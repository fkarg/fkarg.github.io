...
cover-img: /assets/img/gantz-teleport.jpeg
image: /assets/img/gantz-teleport.jpeg
tags:
- thoughts
- reconstructed
---
...
-> Depending on what you are supposed to do, you probably already want to do it
    regardless of (known) outcome
-> You don't have any secrets anymore
...
-> They can create more versions of someone more capable. either continue
    improving to stay relevant or don't.
-> Possible that you never existed before. Examine your identity and past on
    consistency. (If you remember this post, it is likely you existed before
    ... except they made it a checklist of sorts)
-> You are still in control in of your life. Though of course, you will be
    guided by someone/thing else as well.


situation is vastly different if you have been 'guided' growing up though:
-> they are capable of considerable psychological manipulation
-> a perceived feeling of not belonging to yourself anymore, of lost freedom
    potentially wrong, since ... huh.
