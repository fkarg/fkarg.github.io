...
following categories by dedicating a whole chapter to each:
- Value Creation
- Marketing
- Sales
- Value Delivery
...
Each chapter contains a multitude of related concepts, each concept has its own
section and can be understood as the description of a [mental
model][mental-model] of his providing a deeper
[understanding][gears-understanding].
...
### Clarify your Goal
While this seems to be a recurring theme, it is sufficiently important to be
one. Before you start reading something, you can significantly increase focus
and retention by writing down one or two sentences about _why_ you want to read
...
is supposed to be like, or a starting point on how to learn about it.
...
> As a general rule, the only good use of debt or outside capital in setting up
...
> Reinterpretation is possible because your memory is fundamentally
> impermanent.
