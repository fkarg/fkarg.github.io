...
cover-img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/12_Rules_for_Life_Front_Cover_%282018_first_edition%29.jpg/500px-12_Rules_for_Life_Front_Cover_%282018_first_edition%29.jpg'
tags:
- book
- mental resilience
---
...
<!--
## Rule 1: Stand up straight with your shoulders back
Contrary to common belief, this chapter is not about hierarchies being good,
but only about their existence, and how deeply they are rooted within our
biology.
...
## Rule 2: Treat yourself like you are someone you are responsible for helping
- Many people take better care of their pets than of themselves. Or their sims,
  for that matter. (e.g. when supposed to give medication or treatment)
- deep descriptions of chaos and order
- very high level abstract descriptions
- everyone is imperfect, but that should not stop you from caring about
  yourself as you care about others


## Rule 3: Make friends with people who want the best in you
- some friends he grew up with did not so well - they did not _want_ to do well
  (little percepted self-worth)
- Maybe a lot more people could be successful in helping others, if they
  weren't doing it for their ego, telling others that they do the most they
  can, preventing responsibility in the past, present, and future - the
  realization necessary for improvement
- To improve, you need to _want_ to improve, otherwise it won't work. Because
  it requires effort, which is hard to do unmotivated
- => You should find others striving for improvement, and strive with them for it


## Rule 4: Compare yourself who you were yesterday, not who someone else is today
- We want to be best at _something_, and this is easier in smaller towns,
  without many experts, without the high degree of interconnection. It's one of
  the reasons the best experts come from smaller cities - it is easier to grow
  there, to succeed and get the serotonin required to proceed
- If you ask your inner critic, he will answer with something you _want_ to fix
- RetActivatingSys: what you aim at determines what you see
- world as perceived is (necessarily) appearance and illusion, blinded by desires
    - example of video with basketball players and ape dancing in the middle
- listen into yourself what you could and want to improve, and break big tasks
  into smaller ones
...
> There is very little difference between the capacity for mayhem and
