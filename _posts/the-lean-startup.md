...
from all over the place. In some companies it apparently is something every
manager has had to have read. My interest is in startups as well, so this is
kind of a really obvious choice of books to read at some point. I finally
