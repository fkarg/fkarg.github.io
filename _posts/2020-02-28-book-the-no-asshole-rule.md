...
## [6]{#ch6-virtues} The Virtues of Assholes
...
- Sometimes you just think 'what an asshole'
- First time heard:
...
- a couple examples of both male and female 'known' public assholes
- Second test: Does the person target people who are less powerful than him/her?
- do not replace assholes with cowards or obsequious/servile people (='serving')
- intel does 'constructive confrontation' workshops regularly
- he wrote a book about 'Weird Ideas that Work', that hiring 'eccentric' people you actually do not really need might boost overall creativity tremendously
- during research he found out that HR people tended to ignore 'weird' mannerisms from people and downplay them for their achievements on paper
...
- if people are unhappy with their colleagues/supervisor: snowstorm-indicator (if they are there even if they would have an easy excuse)
...
- 'Winning'-mentality, implies that it's okay to be a jerk according to results
- create environments where it just 'is not profitable to be a jerk'

- make the rule public, especially through words and actions
- possible internal rule: it is not allowed to shout at each other (though a lot of them are quite quiet as well)
- be nice to each other - and help each other out!
- make sure that words do not replace deeds, otherwise you will be seen as a hypocrite
...
- ten rules about applying the anti-asshole-rule:
    ...
    - treat assholes as incompetent. Incompetent in communication, if nothing else
    - power corrupts. watch out whom to promote
    - acknowledge differences in status, but mitigate unnecessary ones
    - Manage moments - not practices or systems. Be mindful
    - value and teach constructive confrontation
    - Adopt at most one negative role model total. Keep that one in check accordingly.
    - small events can have massive influence on the company
...
- people try to synchronize with others, becoming and acting more similar to them
- example: noticed a group he was in made him an asshole, so he quit that group
- make sure not to hit the sunk cost fallacy
- select people you work with carefully
- If you cannot quit, reduce contact
- be happy with what you have, you don't need to compete
- focus on cooperation and win-win situations
- sometimes 360°-Evaluations help to recognise behaviours others see, but you might not
- noticing you are an asshole is the first step!
